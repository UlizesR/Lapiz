...
#define LAPIZ_TEXTURE_FN(name) LapizVKTexture##name
extern LapizTexture *LapizVKTextureCreateFromPixels(int width, int height, const unsigned char *pixels);
extern void LapizVKTextureUnload(LapizTexture *texture);
#endif
